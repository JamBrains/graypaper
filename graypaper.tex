...
% This is provided by the CI by copying one of the `style/bg_*` files.
\input{style/bg.tex}
...
\begin{center}
    % This is provided by the CI by copying one of the `style/logo_*` files.
    \input{style/logo.tex}
\end{center}
\vskip10pt
\maketitle
